...
export function Dataspec(obj) {
    ...
    const dataSpec = {};
    dataSpec['sequences'] = [];
    dataSpec['intraSequenceTask'] =
        typeof obj.intraSequenceTask == 'object'
            ? obj.intraSequenceTask
            : (function () {
    ...
    dataSpec['connectionType'] =
        typeof obj.connectionType === 'string'
            ? obj.connectionType
            : (function () {
                  throw "Connection Information must be 'none','dense','sparse type";
              })();
    dataSpec['geneAnnotation'] =
        typeof obj.geneAnnotation === 'boolean'
            ? obj.geneAnnotation
            : (function () {
                  throw 'Gene annotation information is not available';
              })();
    dataSpec['ideogramDisplayed'] =
        typeof obj.ideogramDisplayed === 'boolean'
            ? obj.ideogramDisplayed
            : (function () {
                  throw 'Ideogram information is not avaialable';
              })();
    ...
    if (obj.tasks) {
        dataSpec.tasks = Array.isArray(obj.tasks)
            ? obj.tasks
            : (function () {
                  throw 'Tasks are not provided in correct format. They should be provided as an Array []';
              })();
    }
...
function Sequence(obj) {
    ...
    sequenceId =
        typeof obj.sequenceId == 'string'
            ? obj.sequenceId
            : (function () {
                  throw 'Sequence Id is missing';
              })();

    sequenceName =
        typeof obj.sequenceName == 'string'
            ? obj.sequenceName
            : (function () {
                  throw 'Sequence name should be a string';
              })();
    interFeatureTasks =
        typeof obj.interFeatureTasks == 'object'
            ? obj.interFeatureTasks
            : (function () {
                  throw 'Inter feature tasks should be an object';
              })();
...
function Features(obj) {
    ...
    featureId =
        typeof obj.featureId == 'string'
            ? obj.featureId
            : (function () {
                  throw 'Feature Id is missing';
              })();
    featureGranularity = ['point', 'segment'].indexOf(obj.featureGranularity != -1)
        ? obj.featureGranularity
        : (function () {
              throw 'Feature Granularity must be either Point or Interval';
          })();
    featureDensity =
        ['sparse', 'continous'].indexOf(obj.featureDensity) != -1
            ? obj.featureDensity
            : (function () {
                  throw 'Feature Density must be either Sparse or Continous';
              })();
    featureLabel = obj.featureLabel;
    if (obj['featureInterconnection'] && obj['denseInterconnection']) {
        featureInterconnection =
            typeof obj.featureInterconnection == 'boolean'
                ? obj.featureInterconnection
                : (function () {
                      throw 'Feature Interconnection must be Boolean type';
                  })();
        denseInterconnection =
            typeof obj.denseInterconnection == 'boolean'
                ? obj.denseInterconnection
                : (function () {
...
function Attributes(obj) {
    ...
    attrId =
        typeof obj.attrId == 'string'
            ? obj.attrId
            : (function () {
                  throw 'Attribute Id is missing';
              })();
    dataDescriptor = obj.dataDescriptor; // Allow assignment without typecheck for partial dataspec
    dataType =
        typeof obj.dataType == 'string' && ['quantitative', 'categorical', 'text'].indexOf(obj.dataType) != -1
            ? obj.dataType
            : (function () {
                  throw 'Data Descriptor should be a string and should be either: Quant, Categorical or Text ';
              })();
    intraAttrTask = Array.isArray(obj.intraAttrTask)
        ? obj.intraAttrTask
        : (function () {
    ...
    if (obj.fileName && obj.encodingName) {
        fileName =
        ...
        encodingName =
            typeof obj.encodingName == 'string'
                ? obj.encodingName
                : (function () {
                      throw 'Encoding name is missing';
                  })();
    }
    if (obj.featureInterconnection && obj.denseInterconnection) {
        featureInterconnection =
